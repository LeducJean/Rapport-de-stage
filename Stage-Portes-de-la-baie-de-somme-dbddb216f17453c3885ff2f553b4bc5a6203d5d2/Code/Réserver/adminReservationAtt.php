...
<body>
    ...
    <main class="">
        <div class="jumbotron centerTextReservation textEnBlanc">
            <h1>Réservations en attentes</h1>
        </div>
        <div class="all">
            ...
            <section>
                <div class="table-responsive-sm">
                    <table class="table table-hover table-bordered">
                        <thead>
                            <tr>
                                <th class="jumbotron centerTextReservation textEnBlanc" style="vertical-align: middle;">
                                    ID
                                    réservation</th>
                                <th class="jumbotron centerTextReservation textEnBlanc" style="vertical-align: middle;">
                                    Nom /
                            ...
                            foreach ($results as $row) {
                                ...
                                <tr>
                                    ...
                                    <div id="tentecaravane_<?php echo $idReservation; ?>" class="champ-saisie"
                                        style="display: none;">
                                        <form action="traitementReservation/traitementAccepterTenteCaravane.php"
                                            method="post">
                                            <input type="hidden" name="idReservation" value="<?php echo $idReservation; ?>">
                                            <input type="text" name="valeur" placeholder="Numéro emplacement">
                                            <button type="submit" class="btn btn-success"
                                    ...
                                    <td class="centerTextReservation">
                                        <form action="traitementReservation/traitementRefuser.php" method="post">
                                            <input type="hidden" name="idReservation" value="<?php echo $idReservation; ?>">
